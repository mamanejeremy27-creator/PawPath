export const BADGE_DEFS = [
  ...
  { id: "streak_7", name: "Dedicated", icon: "Sun", desc: "7-day training streak", category: "streaks" },
  { id: "streak_14", name: "Unstoppable", icon: "Mountain", desc: "14-day training streak", category: "streaks" },
  ...
  { id: "exercises_50", name: "Halfway Hero", icon: "CircleDot", desc: "Complete 50 exercises", category: "training" },
  ...
  { id: "xp_10000", name: "XP Legend", icon: "Diamond", desc: "Earn 10,000 XP", category: "training" },
  ...
  { id: "prog_crate", name: "Crate Champ", icon: "Box", desc: "Complete Crate Training", category: "programs" },
  ...
  { id: "prog_reactivity", name: "Leash Pro", icon: "Gauge", desc: "Complete Leash Reactivity", category: "programs" },
  ...
  { id: "photos_25", name: "Memory Keeper", icon: "Aperture", desc: "25 photos saved", category: "journal" },
  ...
  { id: "skill_guardian", name: "Skill Guardian", icon: "Eye", desc: "Keep all skills fresh for 30 days", category: "skills" },

  // ─── Special ───
  { id: "double_trouble", name: "Double Trouble", icon: "Dog", desc: "Add a second dog", category: "special" },
  { id: "pack_leader", name: "Pack Leader", icon: "HeartHandshake", desc: "Train both dogs in the same day", category: "special" },
  ...
  { id: "challenge-trick-star", name: "Trick Star", icon: "Sparkle", desc: "Completed Trick Star Week", category: "challenge" },
  { id: "challenge-leash-pro", name: "Leash Pro", icon: "Route", desc: "Completed Loose Leash Week", category: "challenge" },
  { id: "challenge-puppy-grad", name: "Puppy Graduate", icon: "Bone", desc: "Completed Puppy Bootcamp", category: "challenge" },
  { id: "challenge-social-butterfly", name: "Social Butterfly", icon: "Users", desc: "Completed Socialization Sprint", category: "challenge" },
  { id: "challenge-fitness-champ", name: "Fitness Champ", icon: "Activity", desc: "Completed Canine Fitness Week", category: "challenge" },
  { id: "challenge-crate-lover", name: "Crate Lover", icon: "DoorOpen", desc: "Completed Crate Comfort Week", category: "challenge" },
  { id: "challenge-behavior-boss", name: "Behavior Boss", icon: "Wrench", desc: "Completed Behavior Fix Week", category: "challenge" },
  ...
  // ─── Streak Rewards ───
  { id: "streak-3-days", name: "3-Day Spark", icon: "Sunrise", desc: "3-day training streak", category: "streak" },
  ...
  { id: "streak-30-days", name: "Monthly Master", icon: "CalendarCheck", desc: "30-day training streak", category: "streak" },
  ...
  { id: "streak-recovered", name: "Comeback Kid", icon: "HeartPulse", desc: "Recovered a broken streak", category: "streak" },
  ...
  { id: "challenge-first-complete", name: "First Challenge!", icon: "Award", desc: "Completed your first weekly challenge", category: "challenge" },
  { id: "challenge-5-complete", name: "Challenge Veteran", icon: "Flag", desc: "Completed 5 weekly challenges", category: "challenge" },
  { id: "challenge-streak-3", name: "3 Weeks Strong", icon: "Layers", desc: "Completed 3 challenges in a row", category: "challenge" },
  { id: "challenge-partial-hero", name: "Almost There!", icon: "ArrowUpFromLine", desc: "Completed 5+ days of a challenge", category: "challenge" },
];
